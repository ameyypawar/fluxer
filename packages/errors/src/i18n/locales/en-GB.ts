...
const ERROR_I18N_EN_GB_MESSAGES = defineErrorI18nLocaleMessages({
	...
	'attachments_and_uploads.too_many_files':
		'Too many files. Maximum {maxFiles} {maxFiles, plural, one {file} other {files}} allowed.',
	...
	'calls_and_voice.voice_message_duration_exceeds_limit':
		"Voice message duration can't exceed {maxDuration} {maxDuration, plural, one {second} other {seconds}}.",
	...
	'channels_and_guilds.max_group_dm_recipients_reached':
		"You've reached the maximum of {count} group DM {count, plural, one {recipient} other {recipients}}.",
	'channels_and_guilds.max_group_dms_reached':
		"You've reached the maximum of {count} group {count, plural, one {DM} other {DMs}}.",
	'channels_and_guilds.max_guild_channels_reached':
		"You've reached the maximum of {count} community {count, plural, one {channel} other {channels}}.",
	'channels_and_guilds.max_guild_members_reached':
		"You've reached the maximum of {count} community {count, plural, one {member} other {members}}.",
	'channels_and_guilds.max_guild_roles_reached':
		"You've reached the maximum of {count} community {count, plural, one {role} other {roles}}.",
	'channels_and_guilds.max_guilds_reached':
		"You've reached the maximum of {count} {count, plural, one {community} other {communities}}.",
	...
	'embeds.embed_index_out_of_bounds':
		'Embed index {embedIndex} is out of bounds (message has {embedCount} {embedCount, plural, one {embed} other {embeds}}).',
	'embeds.embed_splash_requires_feature': 'Embed splash requires INVITE_SPLASH feature.',
	'embeds.embeds_exceed_max_characters':
		'Embeds must not exceed {maxCharacters} {maxCharacters, plural, one {character} other {characters}} characters in total.',
	'embeds.too_many_embeds':
		'Too many embeds. Maximum {maxEmbeds} {maxEmbeds, plural, one {embed} other {embeds}} allowed.',
	...
	'invites_and_beta.max_beta_codes_reached':
		"You've reached the maximum of {count} beta {count, plural, one {code} other {codes}}.",
	...
	'invites_and_packs.max_animated_emojis_reached':
		"You've reached the maximum of {count} animated {count, plural, one {emoji} other {emojis}}.",
	'invites_and_packs.max_emojis_reached':
		"You've reached the maximum of {count} {count, plural, one {emoji} other {emojis}}.",
	'invites_and_packs.max_pack_expressions_reached':
		"You've reached the maximum of {count} pack {count, plural, one {expression} other {expressions}}.",
	'invites_and_packs.max_packs_reached':
		"You've reached the maximum of {count} {count, plural, one {pack} other {packs}}.",
	...
	'limits.content_exceeds_max_length':
		'Text must not exceed {maxLength} {maxLength, plural, one {character} other {characters}}.',
	...
	'limits.timeout_cannot_exceed_365_days':
		"Timeout can't be longer than {maxDays} {maxDays, plural, one {day} other {days}} from now.",
	...
	'media_and_memes.max_favorite_meme_tags_exceeded':
		'You can only add up to {limit} {limit, plural, one {tag} other {tags}} per favourite meme.',
	'media_and_memes.max_favorite_memes_reached':
		"You've reached the maximum of {count} favourite {count, plural, one {meme} other {memes}}.",
	...
	'messages.cannot_delete_more_than_100':
		"You can't delete more than {max} {max, plural, one {message} other {messages}} at once.",
	'messages.cannot_edit_others_message': "You can't edit another user's message.",
	'messages.cannot_preload_more_than_100_channels':
		"You can't preload more than {max} {max, plural, one {channel} other {channels}} at once.",
	...
	'mfa_and_passkeys.webauthn_credential_limit_reached':
		"You've reached the maximum of {count} WebAuthn {count, plural, one {credential} other {credentials}}.",
	...
	'misc_limits.max_applications_reached':
		"You've reached the maximum of {limit} {limit, plural, one {application} other {applications}}.",
	'misc_limits.max_bookmarks_reached':
		"You've reached the maximum of {count} {count, plural, one {bookmark} other {bookmarks}}.",
	'misc_limits.max_category_channels_reached':
		"You've reached the maximum of {count} category {count, plural, one {channel} other {channels}}.",
	'misc_limits.max_friends_reached':
		"You've reached the maximum of {count} {count, plural, one {friend} other {friends}}.",
	'misc_limits.max_invites_reached':
		"You've reached the maximum of {count} {count, plural, one {invite} other {invites}}.",
	'misc_limits.max_pins_per_channel_reached':
		"You've reached the maximum of {count} {count, plural, one {pin} other {pins}} per channel.",
	...
	'premium_and_plans.visionary_required_for_bot_discriminator':
		'You must be on the Visionary lifetime plan to customise bot discriminators.',
	...
	'rate_limits.accent_color_changed_too_often':
		"You've changed your accent colour too often recently. Please try again in {minutes} {minutes, plural, one {minute} other {minutes}}.",
	'rate_limits.avatar_changed_too_often':
		"You've changed your avatar too often recently. Please try again in {minutes} {minutes, plural, one {minute} other {minutes}}.",
	'rate_limits.banner_changed_too_often':
		"You've changed your banner too often recently. Please try again in {minutes} {minutes, plural, one {minute} other {minutes}}.",
	'rate_limits.bio_changed_too_often':
		"You've changed your bio too often recently. Please try again in {minutes} {minutes, plural, one {minute} other {minutes}}.",
	...
	'rate_limits.voice_activity_sharing_on_cooldown':
		'You can only update your voice activity sharing default once every 24 hours. Please try again in {retry_after} {retry_after, plural, one {second} other {seconds}}.',
	...
	'stickers_and_emojis.max_reactions_reached':
		"You've reached the maximum of {count} {count, plural, one {reaction} other {reactions}}.",
	'stickers_and_emojis.max_stickers_reached':
		"You've reached the maximum of {count} {count, plural, one {sticker} other {stickers}}.",
	...
	'tos_and_age.must_be_minimum_age':
		'You must be at least {minAge} {minAge, plural, one {year} other {years}} old to create an account.',
	...
	'webhooks.max_webhooks_per_channel_reached':
		"You've reached the maximum of {count} {count, plural, one {webhook} other {webhooks}} per channel.",
	'webhooks.max_webhooks_per_guild_reached':
		"You've reached the maximum of {count} {count, plural, one {webhook} other {webhooks}} per community.",
	'webhooks.max_webhooks_reached':
		"You've reached the maximum of {count} {count, plural, one {webhook} other {webhooks}}.",
